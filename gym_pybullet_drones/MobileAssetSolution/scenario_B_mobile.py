...
def run():
    print("[MOBILE SCENARIO B] 10 vs 13 Asymmetric | Moving Asset")
    ...
    # 46% Bombers (High Threat)
    config = {"num_enemies": NUM_ENEMIES, "spawn_radius": 500.0, "ground_attacker_ratio": 0.46}
